<template lang="pug">
  .page.page-map.color.blue
    section 
      .container
        br
        br
        h4.color.orange.text-center Exhibition Map
        h1.text-center 展覽地圖
      .container
        .row
          .col-sm-5
            ...
            ul
              li(v-for="(work) in works")
                router-link(:to="'/works/n/'+work.key")
                  .tag {{work.id}}
                  h3 {{work.title}}
                  p {{work.data}}
          .col-sm-7
...
.page-map
  background: linear-gradient(45deg, transparent 0% ,transparent 30% ,rgba(255,255,255,0.05) 31%, rgba(255,255,255,0.05) 33% ,transparent 34%)
